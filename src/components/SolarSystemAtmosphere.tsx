...
const PLANETS: PlanetSpec[] = [
  ...
  },
  {
    ...
    moons: [
      { name: "luna", radius: 17, periodSec: 4.5, size: 4, color: "#e2e8f0" },
    ],
  },
  {
    name: "mars",
    ...
    moons: [
      { name: "phobos", radius: 13, periodSec: 3.0, size: 3, color: "#cbd5e1" },
      { name: "deimos", radius: 19, periodSec: 5.5, size: 2.5, color: "#94a3b8" },
    ],
  },
  {
    name: "jupiter",
    ...
    moons: [
      { name: "io", radius: 23, periodSec: 3.2, size: 3, color: "#fef08a" },
      { name: "europa", radius: 29, periodSec: 4.8, size: 3, color: "#e0f2fe" },
      { name: "ganymede", radius: 37, periodSec: 7.5, size: 4.5, color: "#cbd5e1" },
      { name: "callisto", radius: 45, periodSec: 10.5, size: 3.8, color: "#64748b" },
    ],
  },
  {
    name: "saturn",
    ...
    moons: [
      { name: "mimas", radius: 30, periodSec: 4.0, size: 2.8, color: "#cbd5e1" },
      { name: "enceladus", radius: 37, periodSec: 6.2, size: 3.2, color: "#ffffff" },
      { name: "titan", radius: 46, periodSec: 9.5, size: 4.8, color: "#f97316" },
    ],
  },
  {
    name: "uranus",
    ...
    moons: [
      { name: "titania", radius: 22, periodSec: 5.5, size: 3.2, color: "#e2e8f0" },
      { name: "oberon", radius: 28, periodSec: 8.5, size: 3.0, color: "#94a3b8" },
    ],
  },
  {
    name: "neptune",
    ...
    moons: [
      { name: "triton", radius: 24, periodSec: 6.5, size: 3.6, color: "#c084fc", retrograde: true },
    ],
  },
  {
    name: "pluto",
    ...
    moons: [
      { name: "charon", radius: 14, periodSec: 5.0, size: 3.0, color: "#94a3b8" },
    ],
  },
];
